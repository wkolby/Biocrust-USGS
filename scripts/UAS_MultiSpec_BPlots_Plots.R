...
##########BOX PLOT##############################################################
#Plots
B1_means<-PlotLevel_Box(as.vector(as.matrix(Multispec.B1_C)),as.vector(as.matrix(Multispec.B1_A)),as.vector(as.matrix(Multispec.B1_W)),as.vector(as.matrix(Multispec.B1_WA)),c('white','cyan2','red3','magenta3'),paste0(github_dir,'figures/B1_Multispec_Box.png'))
B2_means<-PlotLevel_Box(as.vector(as.matrix(Multispec.B2_C)),as.vector(as.matrix(Multispec.B2_A)),as.vector(as.matrix(Multispec.B2_W)),as.vector(as.matrix(Multispec.B2_WA)),c('white','cyan2','red3','magenta3'),paste0(github_dir,'figures/B2_Multispec_Box.png'))
B3_means<-PlotLevel_Box(as.vector(as.matrix(Multispec.B3_C)),as.vector(as.matrix(Multispec.B3_A)),as.vector(as.matrix(Multispec.B3_W)),as.vector(as.matrix(Multispec.B3_WA)),c('white','cyan2','red3','magenta3'),paste0(github_dir,'figures/B3_Multispec_Box.png'))
B4_means<-PlotLevel_Box(as.vector(as.matrix(Multispec.B4_C)),as.vector(as.matrix(Multispec.B4_A)),as.vector(as.matrix(Multispec.B4_W)),as.vector(as.matrix(Multispec.B4_WA)),c('white','cyan2','red3','magenta3'),paste0(github_dir,'figures/B4_Multispec_Box.png'))
B5_means<-PlotLevel_Box(as.vector(as.matrix(Multispec.B5_C)),as.vector(as.matrix(Multispec.B5_A)),as.vector(as.matrix(Multispec.B5_W)),as.vector(as.matrix(Multispec.B5_WA)),c('white','cyan2','red3','magenta3'),paste0(github_dir,'figures/B5_Multispec_Box.png'))
...
All_means<-PlotLevel_Box(C,A,W,WA,c(c('white','cyan2','red3','magenta3')),paste0(github_dir,'figures/All_BPlots_Multispec_Box.png'))

B1_means<-PlotLevel_GGBox(as.vector(as.matrix(Multispec.B1_C)),as.vector(as.matrix(Multispec.B1_A)),as.vector(as.matrix(Multispec.B1_W)),as.vector(as.matrix(Multispec.B1_WA)),c('white','cyan2','red3','magenta3'),paste0(github_dir,'figures/B1_Multispec_GGBox.png'))
B2_means<-PlotLevel_GGBox(as.vector(as.matrix(Multispec.B2_C)),as.vector(as.matrix(Multispec.B2_A)),as.vector(as.matrix(Multispec.B2_W)),as.vector(as.matrix(Multispec.B2_WA)),c('white','cyan2','red3','magenta3'),paste0(github_dir,'figures/B2_Multispec_GGBox.png'))
B3_means<-PlotLevel_GGBox(as.vector(as.matrix(Multispec.B3_C)),as.vector(as.matrix(Multispec.B3_A)),as.vector(as.matrix(Multispec.B3_W)),as.vector(as.matrix(Multispec.B3_WA)),c('white','cyan2','red3','magenta3'),paste0(github_dir,'figures/B3_Multispec_GGBox.png'))
B4_means<-PlotLevel_GGBox(as.vector(as.matrix(Multispec.B4_C)),as.vector(as.matrix(Multispec.B4_A)),as.vector(as.matrix(Multispec.B4_W)),as.vector(as.matrix(Multispec.B4_WA)),c('white','cyan2','red3','magenta3'),paste0(github_dir,'figures/B4_Multispec_GGBox.png'))
B5_means<-PlotLevel_GGBox(as.vector(as.matrix(Multispec.B5_C)),as.vector(as.matrix(Multispec.B5_A)),as.vector(as.matrix(Multispec.B5_W)),as.vector(as.matrix(Multispec.B5_WA)),c('white','cyan2','red3','magenta3'),paste0(github_dir,'figures/B5_Multispec_GGBox.png'))
C<-c(as.vector(as.matrix(Multispec.B1_C)),as.vector(as.matrix(Multispec.B2_C)),as.vector(as.matrix(Multispec.B3_C)),as.vector(as.matrix(Multispec.B4_C)),as.vector(as.matrix(Multispec.B5_C)))
A<-c(as.vector(as.matrix(Multispec.B1_A)),as.vector(as.matrix(Multispec.B2_A)),as.vector(as.matrix(Multispec.B3_A)),as.vector(as.matrix(Multispec.B4_A)),as.vector(as.matrix(Multispec.B5_A)))
WA<-c(as.vector(as.matrix(Multispec.B1_WA)),as.vector(as.matrix(Multispec.B2_WA)),as.vector(as.matrix(Multispec.B3_WA)),as.vector(as.matrix(Multispec.B4_WA)),as.vector(as.matrix(Multispec.B5_WA)))
W<-c(as.vector(as.matrix(Multispec.B1_W)),as.vector(as.matrix(Multispec.B2_W)),as.vector(as.matrix(Multispec.B3_W)),as.vector(as.matrix(Multispec.B4_W)),as.vector(as.matrix(Multispec.B5_W)))
All_means<-PlotLevel_GGBox(C,A,W,WA,c(c('white','cyan2','red3','magenta3')),paste0(github_dir,'figures/All_BPlots_Multispec_GGBox.png'))
