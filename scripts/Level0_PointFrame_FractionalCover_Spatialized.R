...
Cover<-read.csv2(paste(github_dir,'/data/Cover/Plot/',"2021_DOE_Raw_Veg_Data_for_Bill_20250211.csv",sep=''),sep=',',header=T)
blks=c(1,2,3,4,5)
treats=c("C","L","LW","W")
S1=c()
for(i in 1:length(treats)){
  for(j in 1:length(blks)){
    ...
    tmp=c("S1","B",blks[j],treats[i],colSums(Cover_S1[,c(8,9,10,11,37,38,39,40)])/25)
    S1=rbind(S1,tmp)
  }
}
...
for(i in 1:length(treats)){
  for(j in 1:length(blks)){
    ...
    tmp=c("S2","B",blks[j],treats[i],colSums(Cover_S2[,c(8,9,10,11,37,38,39,40)])/20)
    S2=rbind(S2,tmp)
  }
}
...
for(i in 1:length(treats)){
  for(j in 1:length(blks)){
    ...
    tmp=c("S3","B",blks[j],treats[i],colSums(Cover_S3[,c(8,9,10,11,37,38,39,40)])/25)
    S3=rbind(S3,tmp)
  }
}
...
for(i in 1:length(treats)){
  for(j in 1:length(blks)){
    ...
    tmp=c("S4","B",blks[j],treats[i],colSums(Cover_S4[,c(8,9,10,11,37,38,39,40)])/25)
    S4=rbind(S4,tmp)
  }
}
...
for(i in 1:length(treats)){
  for(j in 1:length(blks)){
    ...
    tmp=c("S5","B",blks[j],treats[i],colSums(Cover_S5[,c(8,9,10,11,37,38,39,40)])/20)
    S5=rbind(S5,tmp)
  }
}
...
for(i in 1:length(treats)){
  for(j in 1:length(blks)){
    ...
    tmp=c("S6","B",blks[j],treats[i],colSums(Cover_S6[,c(8,9,10,11,37,38,39,40)])/25)
    S6=rbind(S6,tmp)
  }
}
...
for(i in 1:length(treats)){
  for(j in 1:length(blks)){
    ...
    tmp=c("S7","B",blks[j],treats[i],colSums(Cover_S7[,c(8,9,10,11,37,38,39,40)])/25)
    S7=rbind(S7,tmp)
  }
}
...
for(i in 1:length(treats)){
  for(j in 1:length(blks)){
    ...
    tmp=c("S8","B",blks[j],treats[i],colSums(Cover_S8[,c(8,9,10,11,37,38,39,40)])/20)
    S8=rbind(S8,tmp)
  }
}
...
for(i in 1:length(treats)){
  for(j in 1:length(blks)){
    ...
    tmp=c("S9","B",blks[j],treats[i],colSums(Cover_S9[,c(8,9,10,11,37,38,39,40)])/25)
    S9=rbind(S9,tmp)
  }
}
...
for(i in 1:length(treats)){
  for(j in 1:length(blks)){
    ...
    tmp=c("S10","B",blks[j],treats[i],colSums(Cover_S10[,c(8,9,10,11,37,38,39,40)])/25)
    S10=rbind(S10,tmp)
  }
}
...
for(i in 1:length(treats)){
  for(j in 1:length(blks)){
    ...
    tmp=c("S11","B",blks[j],treats[i],colSums(Cover_S11[,c(8,9,10,11,37,38,39,40)])/20)
    S11=rbind(S11,tmp)
  }
}
...
for(i in 1:length(treats)){
  for(j in 1:length(blks)){
    ...
    tmp=c("S12","B",blks[j],treats[i],colSums(Cover_S12[,c(8,9,10,11,37,38,39,40)])/25)
    S12=rbind(S12,tmp)
  }
}
